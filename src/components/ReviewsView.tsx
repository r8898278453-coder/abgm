...
export const ReviewsView: React.FC<ReviewsViewProps> = ({
  ...
  const handlePublishReply = (reviewId: string) => {
    ...
    const updated = { ...draftReplies };
    delete updated[reviewId];
    setDraftReplies(updated);
  };
                    ...
                    <div className="bg-indigo-50/70 border border-indigo-200 rounded-2xl p-4 space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-indigo-900 flex items-center gap-1.5">
                          ...
                          AI Drafted Reply ({selectedTone}) • Guardrails Checked
                        </span>
                        <button
                      ...
                      <div className="flex items-center justify-between pt-1">
                        <span className="text-[10px] text-slate-500 flex items-center gap-1">
                          ...
                          Verified: Zero admissions of liability, professional & polite.
                        </span>
                        <div className="flex gap-2">
                          <button
                            onClick={() => {
                          ...
                          <button
                            ...
                            className="bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold px-4 py-2 rounded-xl flex items-center gap-1.5 transition shadow-xs"
                          >
