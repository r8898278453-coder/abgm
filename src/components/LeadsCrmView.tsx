...
export const LeadsCrmView: React.FC<LeadsCrmViewProps> = ({
  ...
  const handleSendWhatsApp = (lead: LeadItem) => {
    // Sanitize phone number for wa.me URL
              ...
              <div className="bg-slate-50 border border-indigo-200 rounded-2xl p-5 space-y-3">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-1">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold px-4 py-2.5 rounded-xl transition shadow-xs"
                  >
